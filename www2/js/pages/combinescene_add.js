...
function msgCallback(data) {
    ...
    if (obj.hasOwnProperty("method") && obj.hasOwnProperty("payload")) {
        if (obj.method == "addCombineSceneCb") {
...
function addCombineScene() {
    ...
    openLoading(10000);
    doAddCombineScene(name, room_id, getTriggerList(), getActionList(), trigger_condition);
}
...
$(function () {
    ...
    layui.use(function () {
                ...
                table.on('toolbar(trigger-table)', function (obj) {
                    switch (obj.event) {
                        case 'exportFile':
                            ...
                            break;
                        // case 'addClickTrigger':
                        //     addTrigger(1, "click", "");
                        //     // var obj2 = table.getData("trigger-table");
                        //     // var str2 = window.JSON.stringify(obj2);
                        //     // console.log("12313" + str2);
                        //     // alert("12313" + str2);
                        //     break;
                        // case 'addSpeechTrigger':
                        //     addTrigger(4, "word", "");
                        //     break;
                        // case 'addTimeTrigger':
                        //     getTimeValue();
        ...
        layui.jquery(".click").text($.i18n.prop('center.combine_scene.click.tips'))
        layui.jquery(".Voice").text($.i18n.prop('center.combine_scene.voice.tips'))
        ...
        layui.jquery(".con").text($.i18n.prop('center.sceneconfig.condition'))
        ...
        form.render()
        console.log($(".layui-laydate-list.laydate-time-list").text());
    });
